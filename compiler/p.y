...
%token <sValue> STRING
%token <sValue> TYPE
%token ADDITION SUBTRACTION MULTIPLICATION DIVISION REMAINDER PLUS_PLUS MINUS_MINUS POWER
...
%token VAR WHILE FOR DO IF THEN ELSE FUNC IN RETURN PRINT
